...
var DaggerMR=[{
    name:'Dague magik', image:'/images/Equipement/Arme/Dagger/Dague magik.png'},{
      ...
      <SideBar/>
        ...
        <div className={styles.equipementContainer}>
            ...
            <div className={styles.equipement}>
                {DaggerMR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>SR</h4>
            <div className={styles.equipement}>
                {DaggerSR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>R</h4>
            <div className={styles.equipement}>
                {DaggerR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>$
            <h4>N</h4>
            <div className={styles.equipement}>
                {DaggerN.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
