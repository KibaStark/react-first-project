...
var RodMR=[{
    ...
    name:'Bâton de seiga', image:'/images/Equipement/Arme/Rod/Bâton de seiga.png'},{
    name:'Bâton du gardien', image:'/images/Equipement/Arme/Rod/Bâton du gardien.png'},{
    name:'Bâton inguz', image:'/images/Equipement/Arme/Rod/Bâton inguz.png'},{
    name:'Bâton magique', image:'/images/Equipement/Arme/Rod/Bâton magique.png'},{
    name:'Bâton magistère', image:'/images/Equipement/Arme/Rod/Bâton magistère.png'},{
    name:'Lance temporelle', image:'/images/Equipement/Arme/Rod/Lance temporelle.png'},{
      ...
      <SideBar/>
        ...
        <div className={styles.equipementContainer}>
            ...
            <div className={styles.equipement}>
                {RodUR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>

            <h4>MR</h4>
            <div className={styles.equipement}>
                {RodMR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>SR</h4>
            <div className={styles.equipement}>
                {RodSR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>R</h4>
            <div className={styles.equipement}>
                {RodR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>N</h4>
            <div className={styles.equipement}>
                {RodN.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
