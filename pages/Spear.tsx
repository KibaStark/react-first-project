...
var SpearMR=[{
    ...
    name:'Lance de glace', image:'/images/Equipement/Arme/Spear/Lance de glace.png'},{
    name:'Lance de lastrologue', image:'/images/Equipement/Arme/Spear/Lance de lastrologue.png'},{
      ...
      <SideBar/>
        ...
        <div className={styles.equipementContainer}>
            ...
            <div className={styles.equipement}>
                {SpearUR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>

            <h4>MR</h4>
            <div className={styles.equipement}>
                {SpearMR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>SR</h4>
            <div className={styles.equipement}>
                {SpearSR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>R</h4>
            <div className={styles.equipement}>
                {SpearR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>N</h4>
            <div className={styles.equipement}>
                {SpearN.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
