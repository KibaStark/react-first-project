...
var BowMR=[{
    ...
    name:'Arc glacial', image:'/images/Equipement/Arme/Bow/Arc glacial.png'},{
    ...
    <div className={styles.container}>
      ...
      <SideBar/>
        ...
        <div className={styles.equipementContainer}>
            ...
            <button className={styles.ButtonGreatBow} onClick={() => {OnElementClick('GreatBow')}}>GreatBow</button>
        ...
        <div className={styles.equipementContainer}>
            ...
            <div className={styles.equipement}>
                {BowUR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>

            <h4>MR</h4>
            <div className={styles.equipement}>
                {BowMR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>SR</h4>
            <div className={styles.equipement}>
                {BowSR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>R</h4>
            <div className={styles.equipement}>
                {BowR.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
            <h4>N</h4>
            <div className={styles.equipement}>
                {BowN.map((equipement, index) => (<Equipement name={equipement.name} key={index} image={equipement.image}/>))}
            </div>
